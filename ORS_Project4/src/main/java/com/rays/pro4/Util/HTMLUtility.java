...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal,
        ...
        StringBuffer sb = new StringBuffer(
                "<select style='width: 218px;  height: 23px;' class='form-control' name='" + name + "'>");
        ...
        if (select)
        {
        	sb.append("<option style='width: 200px;  height: 23px;' selected value=''>--------------Select---------------------`</option>");
        }
...
;
 ...
 public static String getList(String name, String selectedVal, List list) {
        ...
        StringBuffer sb = new StringBuffer("<select style='width: 218px;  height: 23px;' class='form-control' name='" + name + "'>");
        ...
        System.out.println("list ka obj");
       ...
       // StringBuffer sb = new StringBuffer(       "<select style='width: 163px;  height: 23px;' class='form-control' name='" + name + "'>");
        ...
        for (DropdownListBean obj : dd) {
            key = obj.getkey();
            val = obj.getValue();
            System.out.println("key or val me store kiya");
